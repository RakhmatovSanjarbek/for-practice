  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const[
          BottomNavigationBarItem(icon: Icon(Icons.home_filled), label: 'Bosh safiha'),
          BottomNavigationBarItem(icon: Icon(Icons.calendar_month_sharp), label: 'Bronlar'),
          BottomNavigationBarItem(icon: Icon(Icons.store), label: 'Studiolar'),
